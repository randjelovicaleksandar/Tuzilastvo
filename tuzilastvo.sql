...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2017 at 10:08 AM
...
(9, 'asdsa ddas', '3123', '2017-07-05', 'dasd', 'dsadas', 1, 1),
...
ALTER TABLE `vodjenje`
  ADD PRIMARY KEY (`vodjenjeID`),
  ADD UNIQUE KEY `predmetID` (`predmetID`),
  ADD UNIQUE KEY `osumnjiceniID` (`osumnjiceniID`);
...
--
ALTER TABLE `korisnik`
  MODIFY `korisnikID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `predmet`
  MODIFY `predmetID` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tuzilac`
--
ALTER TABLE `tuzilac`
  MODIFY `tuzilacID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `vodjenje`
--
ALTER TABLE `vodjenje`
  MODIFY `vodjenjeID` int(10) NOT NULL AUTO_INCREMENT;
--
